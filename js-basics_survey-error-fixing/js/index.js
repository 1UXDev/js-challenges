...
const nextButton = document.querySelector('[data-js="next-button"]'); // selector was ID before, nicht eineindeutig
...
firstChoiceButton.addEventListener("click", () => {
  ...
  console.log("Selected first choice"); //was lacking the .log method
});
...
secondChoiceButton.addEventListener("click", () => {
  firstChoiceButton.classList.remove("active-choice"); // one of them should add acitve choice
  secondChoiceButton.classList.remove("active-choice");
